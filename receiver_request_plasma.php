...
if(isset($_POST['btnrequest']))
{
	...
	$res1=mysql_query("select max(request_plasma_id) from request_plasma");
	$rid=0;
	...
	$ipath="plasma_img/P".$rid.".png";
	$query="insert into request_plasma values('$rid','$rdate','$recid','$name','$hname','$bgroup','$ipath','0')";
	...
	if(mysql_query($query))
	{
		...
		echo "alert('Plasma Requested Successfully');";
		echo "window.location.href='receiver_view_plasma_req_status.php';";
		echo "</script>";
	}
...
<div class="contact">
	 <div class="container">
		<h3 class="tittle">REQUEST PLASMA</h3>
			<div class="contact-form">
				<div class="col-md-6 contact-grid">
					<form method="post" name="form1" enctype="multipart/form-data">
						...
						<p class="your-para">Select Plasma Prescription Image:</p>
						<input type="file" name="txtpresc" id="txtpresc">
						
						<div class="send">
						<br/>
							<input type="submit" value="REQUEST PLASMA" name="btnrequest" onclick="return validation();">
				...
				<img src="images/plasma1.png" style="margin-left:50px; width:350px; height:250px;">
