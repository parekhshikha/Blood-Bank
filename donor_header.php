...
<div class="logo-head">
	<div class="container">
		...
		<div class="navigation">
				...
				<div class="clearfix"></div>
				<ul class="nav1">
					<li><a class="hvr-overline-from-center button2" href="donor_view_new_req.php">NEW REQUEST</a></li>
					...
					<li><a class="hvr-overline-from-center button2" href="donor_view_accepted_request.php">ACCEPTED REQUEST </a></li>				
